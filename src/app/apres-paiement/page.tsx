  ...
  return (
    <main className="mx-auto max-w-xl px-4 py-12 pb-[max(3rem,env(safe-area-inset-bottom,0px))] text-[#173A2E]">
      ...
      <p className="mt-4 text-sm leading-7 text-[#556159]">
        Le paiement s&apos;ouvre dans un nouvel onglet. Une fois confirmé, Stripe envoie son reçu et Cardin vous adresse ensuite un e-mail de suite dès que le webhook et le SMTP sont actifs.
      </p>
      <ol className="mt-6 list-decimal space-y-3 pl-5 text-sm leading-7 text-[#2A3F35]">
        <li>Vérifiez l&apos;e-mail de confirmation Stripe.</li>
        <li>Attendez l&apos;e-mail Cardin : récap et prochaines étapes.</li>
        <li>Si rien n&apos;arrive rapidement, écrivez à {CARDIN_CONTACT_EMAIL}.</li>
        <li>Revenez sur le parcours marchand pour revoir l&apos;offre ou l&apos;activation.</li>
      </ol>
      ...
      <p className="mt-8 text-xs leading-relaxed text-[#6A726B]">
        Pour finaliser le flux, configurez dans Stripe le webhook vers <code>/api/stripe/webhook</code> et l&apos;URL de retour vers cette page.
      </p>
      <div className="mt-12">
        <PublicFooter />
      </div>

...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-full border text-sm font-medium transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        primary: "border-[#173A2E] bg-[#173A2E] text-[#FBFAF6] hover:bg-[#214F3E]",
        secondary: "border-[#173A2E] bg-transparent text-[#173A2E] hover:bg-[#173A2E] hover:text-[#FBFAF6]",
        subtle: "border-[#D5D8D0] bg-[#F3F3EE] text-[#173A2E] hover:border-[#173A2E]",
      },
      size: {
        sm: "h-9 px-4",
        md: "h-11 px-6",

...
const worlds: WorldDefinition[] = [
  ...
  },
  {
    id: "boulangerie",
    label: "Boulangerie",
    eyebrow: "Routine et quartier",
    hero: "Boulangerie : passage frequent, panier leger a moyen, retour tres rapide.",
    intro: "Panier moyen 6-12 EUR. Rythme quotidien ou hebdo. Cardin resserre la routine, le quartier et les moments plus plats.",
    baselineMonthlyRecovered: 2400,
    baselineActivePaths: 155,
    baselineDominoMultiplier: 1.42,
    baselineTrust: 74,
    adSpend: 550,
    adDuration: "3 jours",
    installPrice: 320,
    basketLine: "Exemple Diamond : 1 fournee signature ou petit-dejeuner par mois pendant 1 an.",
    proofLine: "Routine -> retour dans la semaine -> voisinage active.",
    defaultSummitId: "fournee-monthly",
    walletRewardLabel: "Projection de saison quartier",
    walletNotification: "Votre rythme de quartier evolue avec vos passages.",
    entry: {
      selective: {
        title: "Entree selective",
        lead: "Le lieu choisit ses premiers habitués de quartier.",
        steps: ["70 cartes max", "activation visite 1", "statut evolue visite 2"],
        outcome: "70 cartes -> 130 a 155 parcours actifs via bouche-a-oreille local.",
      },
      mass: {
        title: "Entree diffusion large",
        lead: "QR au comptoir, filtre par retour reel dans la semaine.",
        steps: ["220 cartes distribuees", "visite 1 = dormante", "visite 2 = activation"],
        outcome: "Filtre automatique: seuls les retours reels de quartier activent.",
      },
    },
    tiers: [
      { name: "Dormante", merchantOutcome: "La carte installe une routine visible", socialRadius: "reseau inactif", heightClass: "h-14" },
      { name: "Active", merchantOutcome: "Le retour dans la semaine prend forme", socialRadius: "reseau local", heightClass: "h-24" },
      { name: "Ancree", merchantOutcome: "La boulangerie devient un vrai repere", socialRadius: "reseau local", heightClass: "h-36" },
      { name: "Diamond", merchantOutcome: "Le privilege peut ouvrir 1 a 2 voisins utiles", socialRadius: "reseau active", heightClass: "h-48", marker: "domino" },
      { name: "Recompense saison", merchantOutcome: "La recompense rend la routine desirable", socialRadius: "reseau etendu", heightClass: "h-60", marker: "summit" },
    ],
    summits: [
      {
        id: "fournee-monthly",
        title: "Fournee mensuelle",
        promise: "1 fournee signature par mois pendant 1 an.",
        annualCost: 180,
        visibilityLabel: "Recompense affichee",
        socialLiftLabel: "routine lisible",
        note: "Simple, credibilise le retour rapide.",
        monthlyRecoveredBoost: 1.16,
        dominoBoost: 1,
        trustLift: 1,
      },
      {
        id: "samedi-haut",
        title: "Samedi haut",
        promise: "1 privilege du samedi pour la carte la plus haute.",
        annualCost: 220,
        visibilityLabel: "Recompense amplifiee",
        socialLiftLabel: "quartier renforce",
        note: "Pousse un moment fort sans promo diffuse.",
        monthlyRecoveredBoost: 1.1,
        dominoBoost: 1.08,
        trustLift: 1.07,
      },
      {
        id: "reserve-quartier",
        title: "Reserve quartier",
        promise: "Une reserve cachee gardee pour la recompense.",
        annualCost: 160,
        visibilityLabel: "Recompense selective",
        socialLiftLabel: "desir local conserve",
        note: "Version plus rare, tres maitrisée.",
        monthlyRecoveredBoost: 1.05,
        dominoBoost: 1.03,
        trustLift: 1.05,
      },
    ],
  ...
  },
  {
    id: "caviste",
    label: "Caviste",
    eyebrow: "Selection et degustation",
    hero: "Caviste : panier moyen a eleve, retour choisi, moment social a remettre en mouvement.",
    intro: "Panier moyen 25-45 EUR. Retour hebdo a mensuel. Cardin travaille la selection, la degustation et la revisite sans promo brute.",
    baselineMonthlyRecovered: 2600,
    baselineActivePaths: 108,
    baselineDominoMultiplier: 1.34,
    baselineTrust: 78,
    adSpend: 650,
    adDuration: "3 jours",
    installPrice: 420,
    basketLine: "Exemple Diamond : 1 bouteille decouverte / mois ou acces degustation privee.",
    proofLine: "Selection -> retour choisi -> cercle active par invitation utile.",
    defaultSummitId: "bouteille-decouverte",
    walletRewardLabel: "Projection de saison cave",
    walletNotification: "Votre statut cave evolue avec vos passages.",
    entry: {
      selective: {
        title: "Entree selective",
        lead: "Le caviste cible ses clients a plus forte affinite.",
        steps: ["55 cartes max", "activation visite 1", "statut evolue visite 2"],
        outcome: "55 cartes -> 90 a 108 parcours actifs via selection et degustation.",
      },
      mass: {
        title: "Entree diffusion large",
        lead: "QR a la cave, filtre par retour reel et degustation.",
        steps: ["160 cartes distribuees", "visite 1 = dormante", "visite 2 = activation"],
        outcome: "Filtre automatique: seuls les retours choisis activent la cave.",
      },
    },
    tiers: [
      { name: "Dormante", merchantOutcome: "La carte installe une promesse de selection", socialRadius: "reseau inactif", heightClass: "h-14" },
      { name: "Active", merchantOutcome: "Le retour cave devient lisible", socialRadius: "reseau local", heightClass: "h-26" },
      { name: "Ancree", merchantOutcome: "Le caviste devient un vrai rendez-vous", socialRadius: "reseau local", heightClass: "h-38" },
      { name: "Diamond", merchantOutcome: "Le privilege ouvre 1 a 2 invites utiles", socialRadius: "reseau active", heightClass: "h-50", marker: "domino" },
      { name: "Recompense saison", merchantOutcome: "La recompense rend la selection plus desirable", socialRadius: "reseau etendu", heightClass: "h-62", marker: "summit" },
    ],
    summits: [
      {
        id: "bouteille-decouverte",
        title: "Bouteille decouverte",
        promise: "1 bouteille decouverte par mois pendant 6 mois.",
        annualCost: 300,
        visibilityLabel: "Recompense affichee",
        socialLiftLabel: "selection visible",
        note: "Recompense forte mais bornee.",
        monthlyRecoveredBoost: 1.04,
        dominoBoost: 1,
        trustLift: 1,
      },
      {
        id: "degustation-privee",
        title: "Degustation privee",
        promise: "4 degustations privees dans l'annee.",
        annualCost: 260,
        visibilityLabel: "Recompense amplifiee",
        socialLiftLabel: "moment social renforce",
        note: "Travaille le rituel et l'invitation.",
        monthlyRecoveredBoost: 1.12,
        dominoBoost: 1.08,
        trustLift: 1.07,
      },
      {
        ...
        promise: "Acces reserve a une selection de cave.",
        annualCost: 180,
        visibilityLabel: "Recompense selective",
        socialLiftLabel: "rarete et desir conserves",
        note: "Version plus discrete, centree acces.",
        monthlyRecoveredBoost: 1.06,
        dominoBoost: 1.03,
        trustLift: 1.05,
      },

...
const objectives: Array<{ id: ObjectiveId; label: string; description: string }> = [
  ...
  { id: "rare", label: "Créer quelque chose de rare", description: "Grand Prix, accès, désir exceptionnel." },
]
...
const worlds: MerchantWorld[] = [
  {
    ...
    hero: "Le café vit quand l'habitude devient désir.",
    concepts: {
      return: {
        title: "Diamond Ritual",
        hook: "Un statut mensuel qui se mérite au comptoir.",
        condition: "5 passages actifs dans le mois",
        effect: "1 boisson signature réservée aux Diamond",
      ...
      domino: {
        ...
        condition: "1 invité validé au comptoir",
        effect: "boost direct vers le palier suivant",
        rewardLabel: "Domino Invite / boost de progression",
        statusLabel: "Domino",
        notificationLabel: "Un +1 peut accélérer votre carte aujourd'hui",
        caption: "La progression s'accélère quand le lieu circule.",
      ...
      rare: {
        ...
        statusLabel: "Rare",
        notificationLabel: "Le Grand Prix Café approche pour les cartes actives",
  ...
  },
  {
    ...
    description: "Services à remplir, désir de table, effet groupe.",
    ...
    concepts: {
      return: {
        ...
        effect: "dessert secret réservé aux cartes actives",
        rewardLabel: "Mardi Secret / dessert réservé",
        statusLabel: "Actif",
      ...
      domino: {
        ...
        condition: "1 invité validé sur une table active",
        effect: "boost direct vers un accès de table réservé",
        rewardLabel: "Table Domino / boost a table",
        statusLabel: "Domino",
        notificationLabel: "Inviter quelqu'un peut accélérer votre table",
  ...
  },
  {
    ...
    description: "Passage fréquent, quartier, désir simple mais vivant.",
    ...
    concepts: {
      return: {
        ...
        effect: "accès à une douceur de fournée réservée",
        rewardLabel: "Rituel Fournée / douceur réservée",
        statusLabel: "Actif",
        notificationLabel: "Votre rituel de fournée vous attend demain",
      ...
      domino: {
        title: "Domino Voisin",
        hook: "Faire entrer un proche dans la même boucle.",
        ...
        statusLabel: "Domino",
        notificationLabel: "Inviter un voisin peut accélérer votre carte",
      ...
      rare: {
        ...
        statusLabel: "Rare",
        notificationLabel: "Le Grand Tirage Fournée approche pour les cartes actives",
        caption: "Le désir reste local mais devient exceptionnel.",
        projectionRevenue: 280,
        projectionVolume: 24,
        projectionUnit: "passages",
        dominoLabel: "Fort",
  ...
  },
  {
    ...
    concepts: {
      return: {
        ...
        effect: "accès à un soin signature réservé",
      ...
      domino: {
        ...
        condition: "1 invitée validée",
        effect: "skip d'étape vers Diamond",
        rewardLabel: "Bring a Friend / skip vers Diamond",
        statusLabel: "Domino",
        notificationLabel: "Inviter quelqu'un peut vous faire sauter une étape",
  ...
  },
  {
    ...
    description: "Fréquence suivie, désir de soin, progression douce.",
    ...
    concepts: {
      return: {
        ...
        effect: "accès à un geste soin réservé",
        rewardLabel: "Rituel Peau / geste réservé",
        statusLabel: "Actif",
      ...
      domino: {
        ...
        condition: "1 invitée validée sur rendez-vous",
        effect: "boost direct vers un privilege soin",
        rewardLabel: "Duo Glow / boost de progression",
        statusLabel: "Domino",
        notificationLabel: "Un duo peut accélérer votre carte aujourd'hui",
      ...
      rare: {
        ...
        caption: "Le désir vient de l'exception et du statut.",
  ...
  },
  {
    id: "boutique",
    label: "Boutique",
    eyebrow: "Pièces et désir",
    description: "Passage plus rare, envie, accès, rareté visible.",
    hero: "La boutique gagne quand le désir devient cercle.",
    concepts: {
      return: {
        title: "Cercle Collection",
        hook: "Donner une progression au retour en boutique.",
        condition: "3 achats ou passages actifs",
        effect: "accès à une preview ou pièce réservée",
        rewardLabel: "Cercle Collection / preview réservée",
        statusLabel: "Cercle",
      ...
      domino: {
        ...
        condition: "1 invitée validée en boutique",
        effect: "accès plus rapide à la preview réservée",
        rewardLabel: "Duo Accès / preview accélérée",
        statusLabel: "Domino",
        notificationLabel: "Un duo peut accélérer votre accès cette semaine",
      ...
      rare: {
        title: "Rare Drop",
        hook: "Une pièce ou un accès qui ne s'ouvre pas pour tout le monde.",
        condition: "cartes actives les plus hautes du cycle",
        effect: "accès prioritaire à un rare drop du mois",
        rewardLabel: "Rare Drop / accès prioritaire",
        statusLabel: "Rare",
        notificationLabel: "Un rare drop peut s'ouvrir pour les cartes vives",
        caption: "Le désir naît de l'accès, pas du discount.",
        projectionRevenue: 390,
        projectionVolume: 12,
        projectionUnit: "retours",
        dominoLabel: "Fort",
  ...
  return (
    <div className="w-full rounded-[2rem] border border-[#D9D4C9] bg-[linear-gradient(180deg,#FFFDF8_0%,#F3F0E8_100%)] p-5 shadow-[0_24px_48px_-42px_rgba(27,67,50,0.22)] sm:p-8">
      <div className="max-w-3xl">
        ...
        <p className="mt-2 text-sm text-[#556159]">Chaque lieu garde ses saveurs Cardin : Diamond, Domino, accès rares et progression visible.</p>
      </div>

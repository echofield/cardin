...
export function CardinDedicatedPage({
  ...
  const world = LANDING_WORLDS[merchant.worldId]
    ...
    <div className="pb-[calc(11rem+env(safe-area-inset-bottom,0px))]">
        ...
        <div className="relative mx-auto max-w-6xl px-4 pb-10 pt-12 sm:px-6 lg:px-8 lg:pb-14 lg:pt-16">
          ...
          <div className="mt-10 grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
            <section className="rounded-[1.8rem] border border-[#D7DDD2] bg-[#FFFEFA] p-6 shadow-[0_20px_60px_-44px_rgba(23,58,46,0.22)] sm:p-8">
              ...
              <h2 className="mt-3 font-serif text-3xl text-[#173328] sm:text-4xl">Une lecture du lieu avant même la mise en place.</h2>
              <p className="mt-4 max-w-2xl text-sm leading-7 text-[#556159] sm:text-base">
                {isActivated
                  ? "Cette lecture sert maintenant de base à la mise en place. Le moteur part d'un rythme réel, pas d'un modèle abstrait."
                  : "Pas un profil théorique. Une lecture du rythme, du creux et du bon angle de retour."}
              </p>
            ...
            <section className="rounded-[1.8rem] border border-[#D7DDD2] bg-[linear-gradient(180deg,#FFFEFA_0%,#F1F5EE_100%)] p-6 shadow-[0_20px_60px_-44px_rgba(23,58,46,0.22)] sm:p-8">
              ...
              <h2 className="mt-3 font-serif text-3xl text-[#173328] sm:text-4xl">Le client entre dans une saison, pas dans une carte figée.</h2>
              <p className="mt-4 max-w-2xl text-sm leading-7 text-[#556159] sm:text-base">
                Chaque passage ouvre autre chose. Le lieu voit avancer le retour, puis la valeur, puis la rareté.
              </p>
              <div className="mt-8 flex items-start gap-2 sm:gap-3">
                {TIMELINE_STEPS.map((step, index) => (
                  <div className="flex min-w-0 flex-1 items-start" key={step.passage}>
                    <TimelineNode isActivated={isActivated} isDiamond={step.passage === "Diamond"} label={step.label} passage={step.passage} />
      ...
      <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
        ...
        <section className="mt-10 rounded-[1.8rem] border border-[#E3DDD0] bg-[#FFFEFA] p-6 sm:p-8">
          ...
          <h2 className="mt-3 font-serif text-3xl text-[#173328] sm:text-4xl">Simple à ouvrir. Humaine à installer.</h2>
          <div className="mt-6 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <FactTile label="Ce qui s'ouvre" value="QR comptoir, carte digitale, page de saison" />
          ...
          <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
            <div>
              ...
              <p className="mt-4 text-sm leading-7 text-[#556159] sm:text-base">
                {isActivated
                  ? "Le cadre est désormais réservé pour ce lieu. La mise en place suit le même cap, sans changer de page ni de discours."
                  : "Ce que Cardin vise sur la première saison, sur un rythme cohérent avec ce lieu."}
              </p>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <ProjectionTile
                ...
                value={isActivated ? "Mise en place complète sous 48 h." : "Même page avant et après paiement."}
              />
            </div>
          </div>
        </section>
        ...
        {isActivated ? (
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div className="min-w-0">
              ...
              <p className="mt-1 text-sm leading-6 text-[#556159]">
                Mise en place complète sous 48 h. Contact direct : {contactEmail}
              </p>
            </div>
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div className="min-w-0">
              ...
              <p className="mt-1 text-sm leading-6 text-[#556159]">
                {LANDING_PRICING.compactLabel} · mise en place sous 48 h · cette même page reste votre point de référence.
              </p>
            </div>
            <div className="flex flex-col gap-3 sm:flex-row">
              <a
